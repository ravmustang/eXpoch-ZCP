...
private _ZCP_S_missionAIArray = _this select 23;
private _ZCP_S_missionAISide = _ZCP_S_missionAIArray select 4;
...
if(ZCP_createVirtualCircle) then
{
	...
	_ZCP_S_circle = [_ZCP_S_capturePosition, _ZCP_S_baseRadius, _ZCP_S_city_sizeX, _ZCP_S_city_sizeY, _ZCP_S_missionAISide ] call ZCP_fnc_createVirtualCircle;
};
...
{
    if(_ZCP_S_isCity) then {
        ['Notification', ["ZCP",[format[[18] call ZCP_fnc_translate, _ZCP_S_cityName, (_ZCP_S_missionCapTime / 60)]],"ZCP_Init",_ZCP_S_missionAISide]] call ZCP_fnc_showNotification;
    }else{
        ['Notification', ["ZCP",[format[[0] call ZCP_fnc_translate, _ZCP_S_capPointName, (_ZCP_S_missionCapTime / 60)]],"ZCP_Init",_ZCP_S_missionAISide]] call ZCP_fnc_showNotification;
    };
