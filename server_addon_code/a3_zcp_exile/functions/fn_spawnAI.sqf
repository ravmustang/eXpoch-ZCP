...
switch (ZCP_AI_Type) do {
  case ('DMS'): {
    ...
    private _ZCP_SA_group = [_ZCP_SA_capturePosition, _ZCP_SA_amountAI, _ZCP_SA_difAI select 0, _ZCP_SA_difAI select 1, _ZCP_SA_difAI select 4, _ZCP_SA_minLaunchers, _ZCP_SA_maxLaunchers, _ZCP_SA_capRadius] call ZCP_fnc_createDMSGroup;
