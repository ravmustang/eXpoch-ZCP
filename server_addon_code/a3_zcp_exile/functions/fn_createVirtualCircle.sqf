...
private _ZCP_CVC_NeutralColor = (missionNamespace getVariable [format ["ZCP_circleNeutral_%1Color",toLower(_ZCP_CVC_missionAISide)],"bandit"]);
for '_i' from 0 to 360 step (150 / _ZCP_CVC_radius)*2 do
{
  ...
  _ZCP_CVC_object setObjectTextureGlobal [0, _ZCP_CVC_NeutralColor];
