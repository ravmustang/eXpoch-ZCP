...
switch (ZCP_AI_Type) do {
  case ('DMS'): {
    ...
    for "_i" from 1 to _ZCP_WA_amountOfGroups do {
      ...
      private _ZCP_WA_groupOfAI = [_ZCP_WA_spawnAIPos, _ZCP_WA_unitsPerGroup, _ZCP_WA_difAI select 0, _ZCP_WA_difAI select 1, _ZCP_WA_difAI select 4, _ZCP_WA_minLaunchers, _ZCP_WA_maxLaunchers, 50] call ZCP_fnc_createDMSGroup;
