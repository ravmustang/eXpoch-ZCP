...
_nil = createCenter ZCP_CONFIG_AI_banditSide;

ZCP_CONFIG_AI_banditSide setFriend[ZCP_CONFIG_AI_banditSide,1];
ZCP_CONFIG_AI_heroSide setFriend[ZCP_CONFIG_AI_heroSide,1];
ZCP_CONFIG_AI_survivorSide setFriend[ZCP_CONFIG_AI_survivorSide,1];
