...
ZCP_Add_MissionCompletion2DB = true; //eXpoch add mission capture to database for player stats
...
//eXpoch New toasts colors for sides
ZCP_DMS_ExileToasts_Message_banditColor = "#FF0000";
ZCP_DMS_ExileToasts_Message_heroColor   = "#0000FF";
ZCP_DMS_ExileToasts_Message_survivorColor   = "#FFA500";
...
ZCP_circleNeutralColor = "#(rgb,8,8,3)color(0,1,0,1)"; // removed, will be determined by the mission side
ZCP_circleNeutral_heroColor = "#(rgb,8,8,3)color(0,0,1,1)"; // blue
ZCP_circleNeutral_banditColor = "#(rgb,8,8,3)color(1,0,0,1)"; // red
ZCP_circleNeutral_survivorColor = "#(rgb,8,8,3)color(0.3,0.8,0.1,1)"; // orange

ZCP_circleCappingColor = "#(rgb,8,8,3)color(0,1,0,1)"; // green
ZCP_circleContestedColor = "#(rgb,8,8,3)color(0.4,0,0.5,1)"; // purple
...
/* DonkeyPunchZCP Custom Side Factions */
//ZCP_CONFIG_AI_side = east; // The side where the AI is on.
ZCP_CONFIG_AI_banditSide = EAST;					// The side (team) that AI Bandits will spawn on
ZCP_CONFIG_AI_heroSide	 = WEST;					// The side (team) that AI Heros will spawn on
ZCP_CONFIG_AI_survivorSide = CIVILIAN;					// The side (team) that AI survivors will spawn on
...
//ZCP_FreeColor = "ColorGreen"; // removed for eXpoch hero/bandit/survivor types
ZCP_heroFreeColor = "ColorBlue"; // uncontested marker color -> also correct size
ZCP_banditFreeColor = "ColorRed";
ZCP_survivorFreeColor = "ColorOrange";

ZCP_CappedColor = "ColorGreen"; // uncontested + capping color
ZCP_heroCappedColor = "ColorBlue";//not used
ZCP_banditCappedColor = "ColorRed";//not used
ZCP_survivorCappedColor = "ColorOrange";//not used

ZCP_ContestColor = "colorCivilian"; // contested + capping color
...
ZCP_Background_banditColor = "ColorRed";
ZCP_Background_heroColor   = "ColorBlue";
ZCP_Background_survivorColor   = "ColorOrange";
