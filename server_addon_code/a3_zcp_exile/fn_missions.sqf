...
[
	[
        ...
        ["moderate","random","AWARE", "YELLOW", "bandit"], // Defender AI settings ['DMS difficulty','DMS gear', 'Behaviour', 'CombatMode', 'AI SIDE'] (23)  eXpoch AI SIDE can be "bandit", "hero", "survivor"
        ["moderate","random","AWARE", "YELLOW", "bandit"], // Wave AI difficulty (24)
        true, // spawn rewards in the air after the mission, false -> prespawn them on the ground empty and fill them on completion. ( Boxes and Vechicles only ). (25)
    ...
    [
        ...
        ["moderate","random","AWARE", "YELLOW","hero"], // Defender AI difficulty (23) eXpoch AI SIDE can be "bandit", "hero", "survivor"
        ["moderate","random","AWARE", "YELLOW","hero"], // Wave AI difficulty (24)
	...
	,
		    ...
		    [
		        ...
		        1, // Minimum amount of launchers for Wave AI
		        1 , // Maximum amount of launchers for Wave AI
		        ["moderate","random","AWARE", "YELLOW","bandit"], // Defender AI difficulty (23) eXpoch AI SIDE can be "bandit", "hero", "survivor"
		        ["moderate","random","AWARE", "YELLOW","bandit"], // Wave AI difficulty (24)
		        false, // spawn rewards in the air after the mission, false -> prespawn them on the ground empty and fill them on completion. ( Boxes and Vechicles only ). (25)
		        true, // City mode. -> Takes a city/village from the map as cappoint and places a flag in the center ( No base file needed ). This ignores the position configs. (26)
		        true // Allow spawning of extra objects in the town if sqf file(s) is/are provided. (27)
